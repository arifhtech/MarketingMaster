...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Explore how advanced AI technologies are transforming businesses across industries and creating new opportunities.",
    date: "June 12, 2025",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Learn the key architectural decisions and development practices that ensure your web applications can scale effectively.",
    date: "May 28, 2025",
    image:
      "https://images.unsplash.com/photo-1576444356170-66073046b1bc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400",
  ...
  {
    id: 3,
    title: "Mobile UX Design Trends to Watch in 2023",
    excerpt:
      "Discover the latest user experience design trends that are shaping the future of mobile applications.",
    date: "April 15, 2025",
    image:
  ...
  //   excerpt: "Why more organizations are adopting headless content management systems for flexibility and performance.",
  //   date: "March 17, 2023",
  ...
  // {
  //   id: 5,
  //   title: "How to Implement Effective DevOps Practices",
  //   excerpt: "A practical guide to implementing DevOps methodologies that improve deployment frequency and reliability.",
  ...
  // {
  //   id: 6,
  //   title: "The Impact of Large Language Models on Business Processes",
  //   excerpt: "How LLMs like GPT-4 are revolutionizing automation, customer service, and content creation across industries.",
