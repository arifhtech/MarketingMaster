...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center">
      ...
      {/* Blob Shapes */}
      <div className="absolute top-0 right-0 w-[60vw] h-[60vw] sm:w-[40vw] sm:h-[40vw] bg-secondary/30 rounded-full filter blur-3xl opacity-30 animate-blob"></div>
      <div className="absolute bottom-0 left-0 w-[45vw] h-[45vw] sm:w-[30vw] sm:h-[30vw] bg-accent/20 rounded-full filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/2 left-1/4 w-[37vw] h-[37vw] sm:w-[25vw] sm:h-[25vw] bg-white/10 rounded-full filter blur-3xl opacity-10 animate-blob animation-delay-4000"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mb-8 text-white/90">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white px-4 sm:px-6 py-3 rounded-xl shadow-lg font-medium transition-all duration-300 inline-flex items-center justify-center hover:translate-y-[-2px] hover:shadow-2xl active:scale-95 group min-h-[48px] w-full sm:w-auto"
              >
              ...
              <Link
                href="/services"
                className="bg-white/10 hover:bg-white/20 text-white px-4 sm:px-6 py-3 rounded-xl shadow-md font-medium border border-white/20 transition-all duration-300 inline-flex items-center justify-center hover:translate-y-[-2px] hover:shadow-xl active:scale-95 group min-h-[48px] w-full sm:w-auto"
              >
