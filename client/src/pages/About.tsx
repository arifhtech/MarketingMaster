  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="We are a software company passionate about building scalable, intelligent, and user-focused digital products." />
      </Helmet>
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Founded in 2013, NexGen Solutions began with a simple mission: to help businesses leverage technology for sustainable growth.
                  Our team of passionate developers, designers, and strategists has grown from a small startup to a versatile digital partner
                  for companies around the world.
                </p>
                <p className="text-lg text-gray-600 mb-6">
                  We believe that great software isn't just about writing code—it's about understanding business challenges and creating
                  solutions that drive real value. From stunning websites to advanced AI systems, we approach each project with a focus
                  on quality, innovation, and results.
                </p>
                <p className="text-lg text-gray-600">
                  Today, we're proud to work with clients ranging from ambitious startups to established enterprises, helping them navigate
                  the ever-changing digital landscape and stay ahead of the competition.
                </p>
              </div>
              <div>
                <img 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  ...
                  improve efficiency, and create exceptional user experiences. We're committed to
                  delivering technology that solves real problems and creates measurable value.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-gray-600">
                  To become the most trusted technology partner for forward-thinking businesses worldwide.
                  We envision a future where every organization, regardless of size, has access to powerful,
                  user-friendly software that helps them thrive in a digital-first world.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    With 15+ years in software development and business leadership, Michael founded NexGen Solutions to help companies thrive in the digital age.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    Sarah leads our technical strategy and engineering teams, bringing extensive experience in AI, cloud architecture, and software development.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    David ensures our solutions not only function perfectly but provide intuitive, engaging experiences for users.
                  </p>
                </div>
              </div>
            </div>
