      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Our unique approach combines technical expertise, business acumen, and innovative solutions 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">
              One team, every solution—offering seamless, end-to-end digital services from brand new 
              websites and mobile apps to advanced AI/ML integrations and custom LLM models.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">
              We deliver at startup speed and adapt to your business—no red tape, just results. Need a 
              stunning site last week? You'll get rapid prototyping, MVPs, and launch-ready builds—fast.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">
              Our edge is intelligence. Unlike vanilla agencies, we bake modern AI/ML capabilities into 
              everything—from smart chatbots to automated workflows—future-proofing your business.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">
              We stand out by deeply learning each client's goals, personalizing our solutions, and 
              obsessing over measurable outcomes—traffic, conversions, and revenue.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">
              We're your long-term technology ally, not a one-off vendor—bringing strategic insight, 
              transparent communication, and a portfolio of success stories. We focus on building lasting 
              relationships and helping your business grow through technology excellence.
            </p>
          </div>
        </div>
      </div>
